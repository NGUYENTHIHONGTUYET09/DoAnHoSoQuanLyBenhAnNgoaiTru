...
public class Them_Sua_NhanVienGUI extends JFrame {
    ...
    public void init() {
        ...
        ngaySinhChooser.setFont(font_2);
    ...
    public void showNhanVienInfo(NhanVien nv) {
        ...
        combobox_VAITRO.setSelectedItem(nv.getVAITRO());
    }
