...
public class Them_Sua_NhanVienGUI extends JFrame {
	...
	public void init() {
		...
		GridLayout layout = new GridLayout(7, 2, 0, 10);
                ...
                //(HOTEN, NGAYSINH, DIACHI, GIOITINH, NGAYVL, VAITRO)
...
//	    String NGAYVL = this.ngaySinhChooser.getText();
...
//            jtextfield_NGAYSINH.setText(nv.getNGAYSINH().toString());
            ngayVLChooser.setDate(nv.getNGAYSINH());
            ...
            ngaySinhChooser.setDate(nv.getNGAYVL());
